...
export const Input = ({ icon: Icon, ...props }) => {
  return (
    <div className="relative w-full h-10">
      ...
      <input
        {...props}
        className="w-full h-10 pl-10 pr-3 py-3 bg-white rounded-lg border focus:border-green-500 focus:ring-2 focus:ring-green-500 text-green-800 placeholder-black transition duration-200 font-normal text-sm"
      />
    </div>
  );
};
...
export const PasswordInput = ({ icon: Icon, ...props }) => {
  return (
    <div className="relative w-full h-10">
      ...
      <input
        {...props}
        className="w-full pl-10 pr-3 py-3 h-10 bg-white rounded-lg focus:border-green-500 focus:ring-2 focus:ring-green-500 text-green-800 placeholder-green-800 transition duration-200 font-normal text-sm"
      />
